...
function App() {
  ...
  const updateDateState = (potentialReservation, workingReservationsState)=>{
    ...
    let newState = workingReservationsState;
    if(workingReservationsState[potentialReservation.date]){
  ...
  const mergeNewReservationsToState = (newReservations, workingReservationsState)=>{
    let newState = workingReservationsState;
    ...
    Object.keys(newReservations).map((dateKey)=>{ // loop through date reservations for this pet
      ...
      const updatedDateState = updateDateState(newReservations[dateKey], newState);
      if(updatedDateState){
